        ...
        <div className="flex flex-col sm:flex-row items-center gap-4">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem onClick={() => setSelectedFilter("Con cita hoy")}>
                Con cita hoy
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => setSelectedFilter("Pendientes de atención")}>
                Pendientes de atención
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => setSelectedFilter("Nuevos pacientes")}>
                Nuevos pacientes
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
          ...
          <div className="p-6 flex items-start space-x-4 flex-1">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-y-1 gap-x-4 mt-2 text-sm text-muted-foreground">
                <div className="flex items-center">
                  ...
                  <span>{calculateAge(patient.dob)} años ({patient.gender === "male" ? "M" : "F"})</span>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <span>{patient.totalVisits} consultas totales</span>
                </div>
              </div>
              
              {patient.allergies && patient.allergies.length > 0 && (
                <div className="mt-3 flex items-center flex-wrap gap-1">
                  <span className="text-xs font-medium text-red-600 mr-1">Alergias:</span>
            ...
            <div className="hidden md:flex items-center space-x-2">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  <Link href={`/dashboard/doctor/patients/${patient.id}/expediente`}>
                    <DropdownMenuItem>
                      <Stethoscope className="mr-2 h-4 w-4" />
                      <span>Actualizar expediente</span>
                    </DropdownMenuItem>
                  </Link>
                  <Link href={`/dashboard/doctor/citas/new?patientId=${patient.id}`}>
                    <DropdownMenuItem>
                      <CalendarPlus className="mr-2 h-4 w-4" />
                      <span>Agendar cita</span>
                    </DropdownMenuItem>
                  </Link>
                  <Link href={`/dashboard/doctor/recetas/new?patientId=${patient.id}`}>
                    <DropdownMenuItem>
                      <FileText className="mr-2 h-4 w-4" />
                      <span>Nueva receta</span>
                    </DropdownMenuItem>
                  </Link>
                  <Link href={`/dashboard/doctor/laboratorio/new?patientId=${patient.id}`}>
                    <DropdownMenuItem>
                      <Activity className="mr-2 h-4 w-4" />
